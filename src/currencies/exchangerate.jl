immutable ExchangeRate
	...
	rateChain::Tuple{ExchangeRate, ExchangeRate}

	ExchangeRate(source::Currency, target::Currency, rate::Float64)=new(source, target, rate, :Direct)
	ExchangeRate(source::Currency, target::Currency, rate::Float64, type_::Symbol, rateChain::Tuple{ExchangeRate, ExchangeRate})=new(source, target, rate, type_, rateChain)
end
